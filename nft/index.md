...
###  NFT China
![图片名字](./pics/3333.png)
>这是一个中国的NFT平台，售卖作品无需注册数字钱包，使用人民币计价，使用信用卡进行作品的购买和收款方式。       
>作品会上链，创作者拥有版税。固定为2%。        
> __技术信息：__      没查到
> __进入门槛：__       邮件注册
> 成为艺术家，需要提交以下信息
...
> * 电话号
> * 个人或者机构？
> 1. 个人（作品上限20个，审核费¥200）
> 2. 机构/工作室（作品上限100个，审核费¥600）
> * 您是从哪个渠道了解到本平台的呢？
_审核工作将在两个工作日内完成，收取审核费是为了保障平台作品的质量与维护区块链网络数据安全。如果您的作品没有通过审核，您会在3个工作日内收到退款。 当您的作品在NFT中国交易额超过¥10000时，您可申请退还审核费用。_

#### 我的作品是油画/雕塑/国画等实物作品，如何变成NFT?
绑定实物作品的艺术品销售，与数字艺术品销售的区别在于发布和成交两个环节。
* 发布环节：绑定实物的艺术品销售，需要将实物作品拍照、拍摄、或者扫描上传，格式为png（图像），或者mp4（录影）。除此之外，还须上传艺术家与实物作品的合影，该合影不会公开，仅作为创作者版权的法律依据。
* 成交环节：成交时，NFT中国会将作品的区块链Token转移给买家。同时，艺术家需要将实物艺术品邮寄给买家。运输费与保险费视情况而定，您的平台小二会与您沟通具体事项。
* 其他注意事项：如果您的实物作品已出售，您须立即通知平台将作品下架。我们会将NFT销毁或者发送给您指定的买家。如果您没有及时通知平台而造成作品重复销售，由此带来的法律风险，将由艺术家本人或艺术家工作室自行承担。

网址:[nftcn](https://www.nftcn.art/)
...
> __收费政策：__ 第一次将NFT上架出售，需要交矿工费用；之后再上架，直到有人买的时候，才需要支付矿工费用；
...
|集合名|  交易资金量 |   底价  | 拥有者数量 | NFT个数|
|---|---|   ---  | --- | --- |
|Loot (for Adventurers) | 62.9K ETH | 6.04ETH | 2.5K | 7.8K |
|Bored Ape Yacht Club | 157.6K ETH | 34.38ETH | 5.4K | 10K |
|CryptoPunks    |    485K ETH  |    |   3K    |   10K   |
|1    |    2 ETH  |  3 ETH  |   4    |   5   |
|1    |    2 ETH  |  3 ETH  |   4    |   5   |
|1    |    2 ETH  |  3 ETH  |   4    |   5   |
|1    |    2 ETH  |  3 ETH  |   4    |   5   |
...
### foundation
![图片名字](./pics/7777.png)
> 一个民主的平台社区，想要成为艺术家（创作者），你得攒够足够多的点赞数                 
>通过社区投票，鼓励艺术家支持其他艺术家，并为社区主导的策展模式奠定基础，将权力交到创作者手中。在新的创意经济中，我们大家一起发财。            
> __技术信息：__   使用以太坊网络，使用以太币ETH交易             
> __进入门槛：__   成为交易者，使用MetaMask钱包连接上即可                 
> 成为艺术家
>1.  通过推特或者Ins至少一个社交媒体帐户验证您的个人资料，以证明您在 Foundation 上的个人资料的真实性。
>2. 将你的钱包地址发一个公共推文，然后将推文的地址提交，以证明你拥有这个推特账户。
> 3. 将你的foundation账户发送到你的推特或者ins，如果得到的点赞数越多，你就越容易成为艺术家

网址:[foundation.app](https://foundation.app/)



### cryptoart
![图片名字](./pics/5555.png)
>这是一个NFT艺术品聚合展示中心，此平台上展示了许多来自于其他平台的作品，这个平台本身没有交易和登录功能，只是收录了一堆作品和艺术家。                       
![图片名字](./pics/6666.png)
>交易图表
网址:[cryptoart.io](https://cryptoart.io/)



### artblocks
![图片名字](https://p5.toutiaoimg.com/large/pgc-image/9d36a746e76e4766ad263e9322e38db0)
>ArtBlocks是一个生成随机艺术品的平台。它是由ErickSnowfro 在2020年推出，是一个专注于可编程、生成性内容的平台，其生成的内容在以太坊区块链上是不可改变的。那么「随机艺术品」是如何随机的呢？这个随机过程是受一串数字控制的，这串数字存储在以太坊链上的一个非同质化代币（NFT）上。之后这个代币所存储的数字串控制你所购买艺术品的一系列属性，最终生成属于你的独一无二的艺术品。                       
>如果你是一个买家，比较看好某个艺术家的风格，然后支付后开始铸造，算法生成随机的同风格的艺术品就会被发送到你的账户中，以代币的形式存在，最终的作品可能是静态图像、3D模型或交互式的艺术品。每个输出都是不同的，并且在平台上创建的内容类型具有无限种可能性，但每个项目可铸造的艺术品的数量是一定的，也就是说一旦铸造满了，这个项目就不会有新的作品生成了。                       
>这是一个铸造平台，你可挑选一个自己喜欢的作品，然后将其铸造为NFT，这意味着，你在这平台上看到的大部分作品都是未曾铸造的，只是作为作品展示。          
[更多教程](https://sunnews.site/game/71147.html)

网址:[artblocks.io](https://artblocks.io/)
